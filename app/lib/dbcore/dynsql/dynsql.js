...
var sql_string_1 = require("./sql-string");
// Keywords
...
var DynSQL = /** @class */ (function () {
    ...
    DynSQL.prototype.get = function (table) {
        this.records.push(new records_1.DSelect('*'));
        var rec = new records_1.DFrom(table);
    ...
    DynSQL.prototype.insert = function (data, tableName) {
    ...
    DynSQL.prototype.set = function (column, value, escape) {
    ...
    ////////////////////////////////////////
    // SELECT
    DynSQL.prototype.escpaeVal = function (value) {
        var result = value;
    ...
    DynSQL.prototype.parseSet = function (sql) {
        ...
        for (var i = 0; i < this.records.length; i++) {
            ...
            if (record instanceof records_1.DSet) {
                ...
                var val = rec.escape ? this.prepValue(rec.value) : rec.value;
                sql += " " + rec.column + "='" + val + "'";
                localCounter++;
            }
        } // end for
